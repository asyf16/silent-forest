...
function App() {
  ...
  const handleSliderChange = (value) => {
    console.log("Slider Value Updated:", value); // Log the new slider value
    setSliderValue(Number(value)); // Update slider value in parent as a number
    console.log(sliderValue)
  };

  useEffect(() => {
    // console.log(micDecibels);
    if (micDecibels) volumeInput.value = micDecibels;
    ...
    if (quietTime > 400 && !bearInput.value) {
